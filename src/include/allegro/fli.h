...
AL_FUNC(int, play_fli, (AL_CONST char *filename, struct BITMAP_ *bmp, int loop, AL_METHOD(int, callback, (void))));
AL_FUNC(int, play_memory_fli, (void *fli_data, struct BITMAP_ *bmp, int loop, AL_METHOD(int, callback, (void))));
...
AL_VAR(struct BITMAP_ *, fli_bitmap);   /* current frame of the FLI */
