...
AL_FUNC(void, _soft_polygon3d, (struct BITMAP_ *bmp, int type, struct BITMAP_ *texture, int vc, V3D *vtx[]));
AL_FUNC(void, _soft_polygon3d_f, (struct BITMAP_ *bmp, int type, struct BITMAP_ *texture, int vc, V3D_f *vtx[]));
AL_FUNC(void, _soft_triangle3d, (struct BITMAP_ *bmp, int type, struct BITMAP_ *texture, V3D *v1, V3D *v2, V3D *v3));
AL_FUNC(void, _soft_triangle3d_f, (struct BITMAP_ *bmp, int type, struct BITMAP_ *texture, V3D_f *v1, V3D_f *v2, V3D_f *v3));
AL_FUNC(void, _soft_quad3d, (struct BITMAP_ *bmp, int type, struct BITMAP_ *texture, V3D *v1, V3D *v2, V3D *v3, V3D *v4));
AL_FUNC(void, _soft_quad3d_f, (struct BITMAP_ *bmp, int type, struct BITMAP_ *texture, V3D_f *v1, V3D_f *v2, V3D_f *v3, V3D_f *v4));
...
/* Note: You are not supposed to mix ZBUFFER with BITMAP_ even though it is
 * currently possible. This is just the internal representation, and it may
 * change in the future.
 */
typedef struct BITMAP_ ZBUFFER;

AL_FUNC(ZBUFFER *, create_zbuffer, (struct BITMAP_ *bmp));
...
AL_FUNC(void, clear_scene, (struct BITMAP_* bmp));
AL_FUNC(void, destroy_scene, (void));
AL_FUNC(int, scene_polygon3d, (int type, struct BITMAP_ *texture, int vx, V3D *vtx[]));
AL_FUNC(int, scene_polygon3d_f, (int type, struct BITMAP_ *texture, int vx, V3D_f *vtx[]));
