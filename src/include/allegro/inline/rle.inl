...
AL_INLINE(void, draw_rle_sprite, (struct BITMAP_ *bmp, AL_CONST struct RLE_SPRITE *sprite, int x, int y),
{
   ASSERT(bmp);
   ASSERT(sprite);
...
AL_INLINE(void, draw_trans_rle_sprite, (struct BITMAP_ *bmp, AL_CONST struct RLE_SPRITE *sprite, int x, int y),
{
   ASSERT(bmp);
   ASSERT(sprite);
...
AL_INLINE(void, draw_lit_rle_sprite, (struct BITMAP_ *bmp, AL_CONST struct RLE_SPRITE *sprite, int x, int y, int color),
{
   ASSERT(bmp);
   ASSERT(sprite);
   ASSERT(bmp->vtable->color_depth == sprite->color_depth);
