...
void c_nes :: Open (int PAL, const char *FilePath)
{
    ...
    switch (o_rom->information ().mapper)
    {
        ...
        case 1:
            __NEW (o_mapper, c_mapper_001);
            break;
        
        case 2:
            __NEW (o_mapper, c_mapper_002);
            break;
        ...
        case 5:
            __NEW (o_mapper, c_mapper_005);
            break;
        
        case 7:
            __NEW (o_mapper, c_mapper_007);
            break;
        
        case 9:
            __NEW (o_mapper, c_mapper_009);
            break;
        
        case 10:
            __NEW (o_mapper, c_mapper_010);
            break;
        
        case 11:
            __NEW (o_mapper, c_mapper_011);
            break;
        
        case 16:
            __NEW (o_mapper, c_mapper_016);
            break;
        
        case 21:
            __NEW (o_mapper, c_mapper_021);
            break;
        ...
        case 34:
            __NEW (o_mapper, c_mapper_034);
            break;
        
        case 68:
            __NEW (o_mapper, c_mapper_068);
            break;
        
        case 69:
            __NEW (o_mapper, c_mapper_069);
            break;
        
        case 71:
            __NEW (o_mapper, c_mapper_071);
            break;
        
        case 91:
            __NEW (o_mapper, c_mapper_091);
            break;
